...
m1_07_2020 <- read_xlsx("D2020_07_e.xlsx")
m2_08_2020 <- read_xlsx("D2020_08_e.xlsx")
m3_09_2020 <- read_xlsx("D2020_09_e.xlsx")
m4_10_2020 <- read_xlsx("D2020_10_e.xlsx")
m5_11_2020 <- read_xlsx("D2020_11_e.xlsx")
m6_12_2020 <- read_xlsx("D2020_12_e.xlsx")
m7_01_2021 <- read_xlsx("D2021_01_e.xlsx")
m8_02_2021 <- read_xlsx("D2021_02_e.xlsx")
m9_03_2021 <- read_xlsx("D2021_03_e.xlsx")
m10_04_2021 <- read_xlsx("D2021_04_e.xlsx")
m11_05_2021 <- read_xlsx("D2021_05_e.xlsx")
m12_06_2021 <- read_xlsx("D2021_06_e.xlsx")
...
### There are a few problems we may to fix:
...
### This shows there are 2529695 members and 1928711 casual riders.
...
### This was already done in the file from the analysis in Excel. I'm doing it again here for comparison to the calcuations in Excel.
### Add a "ride_length" calculation to all_trips (in seconds)
Checkout more about [difftime](https://stat.ethz.ch/R-manual/R-devel/library/base/html/difftime.html).

all_trips$ride_length_r <- difftime(all_trips$end_time,all_trips$start_time)

### Inspect the structure of the columns
str(all_trips)

### Convert "ride_length" from Factor to numeric so we can run calculations on the data
- is.factor(all_trips$ride_length_r)
- all_trips$ride_length <- as.numeric(as.character(all_trips$ride_length_r))
- is.numeric(all_trips$ride_length_r)
...
all_trips_v3 %>% 
  ...
  labs(title= "Number of Rides by Type of Rider: Member or Casual", 
       subtitle = "Total Rides for July 2020 - June 2021 per Day, Chicago", 
       caption = "Public data has been made available by Motivate International Inc.") +
  xlab("Day of Week") +
