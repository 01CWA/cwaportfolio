...
We'll use our new, cleaned table that we wrote to a csv file above (clean_table_result.csv in .../output/kaggle/working to use in Tableau and create three visualizations to see this in more detail.

In the [first tab and below](https://public.tableau.com/views/StorefrontVacanciesonBroadwayinAugust2020/OverallMapView?:language=en-US&:display_count=n&:origin=viz_share_link) we have a map highlighting the overall concentraion of storefront vacancies on Broadway in Manhattan in August 2020.]

Next in the [second tab and below](https://public.tableau.com/views/StorefrontVacanciesonBroadwayinAugust2020/NumberofVacanciesbyCommunityBoardandZipCode?:language=en-US&:display_count=n&:origin=viz_share_link) we have a visulaization of the number of vacant storefronts on Broadway in Manhattan per community board and zip code in August 2020.
