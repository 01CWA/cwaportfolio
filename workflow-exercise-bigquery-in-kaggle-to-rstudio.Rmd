---
title: An R Markdown document converted from "workflow-exercise-bigquery-in-kaggle-to-rstudio.ipynb"
...
In the [first tab here we have a map highlighting the overall concentraion of storefront vacancies on Broadway in Manhattan in August 2020.](https://public.tableau.com/views/StorefrontVacanciesonBroadwayinAugust2020/OverallMapView?:language=en-US&:display_count=n&:origin=viz_share_link)
